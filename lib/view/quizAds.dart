...
class QuizAds extends StatefulWidget {
  @override
  _QuizAdsState createState() => _QuizAdsState();
}

class _QuizAdsState extends State<QuizAds> {
                ...
                (index) {
                  ...
                  return ListTile(
                    ...
                    leading: Radio<int>(
                      value: index,
                      groupValue:
                          selectedOptionIndex, // Reflect selected option
